                    ...
                    <h3 class="h5 mb-4 text-center" style="display: flex;flex-direction:row;justify-content:space-evenly;">
                        ...
                        <form action="" method="post">
                            ...
                            <?php 
                                ...
                                $modules = $admin->getModule($_SESSION['module']);
                                while($module = $modules->fetch()){
                                    if($_SESSION['module'] != $module[0]) echo '<option value="'.$module[0].'">'.$module[0].'</option>';
                                }
                                ?>
                            </select>
                        </form>
                    ...
                    <div class="table-wrap" style="margin-bottom:100px;">
                        ...
                        <thead class="thead-primary">
                            <tr>
                                ...
                                <th style="text-align:center;margin:0;padding:25px 5px;">DS</th>
                                <th style="text-align:center;margin:0;padding:25px 5px;">Exam</th>
                                <th style="text-align:center;margin:0;padding:25px 5px;">tp</th>
                                <th style="text-align:center;margin:0;padding:25px 5px;">Projet</th>
                                    ...
                                    while($student = $students->fetch()){
                                        ...
                                        <tr class="alert" role="alert">
                                            <td style="text-align:center">
                                                '.$student['Nom_Mat'].'
                                                <input type="text" name="Nom_Mat['.$count.']" value="'.$student['Nom_Mat'].'" style="display:none;">
                                            </td>
                                        <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="ds" class="quantity form-control input-number" min="0" max="8" value="0" step="2">
                                                            </div>
                                                        </td>
                                        <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="exam" class="quantity form-control input-number" min="0" max="8" value="0" step="2">
                                                            </div>
                                                        </td>
                                        <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="tp" class="quantity form-control input-number" min="0" max="8" value="0" step="2">
                                                            </div>
                                                        </td>
                                        <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="projet" class="quantity form-control input-number" min="0" max="8" value="0" step="2">
                                                            </div>
                                                        </td>
                                        <td style="text-align:center">
                                                <div class="email">
