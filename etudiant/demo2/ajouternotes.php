...
$students = $admin->getAdmin($_SESSION['module']);
}
...
if(!isset($_POST['semestre']) && !isset($_POST['module'])){
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="apps_todoList.html" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                    ...
                    <form action="note.php" method="POST">
                        ...
                        <thead class="thead-primary">
                            <tr>
                                ...
                                <th style="text-align:center;margin:0;padding:25px 5px;"><input type="text" required style="border:none;"name="DS" value="DS"></th>
                                <th style="text-align:center;margin:0;padding:25px 5px;"><input type="hidden" name="Examen">Examen</th>
                                <th style="text-align:center;margin:0;padding:25px 5px;"><input type="hidden" name="Tp">Tp</th>
                                <th style="text-align:center;margin:0;padding:25px 5px;"><input type="hidden" name="Projet">Projet</th>
                                <th style="text-align:center;margin:0;padding:25px 5px;">Coefficient</th>
                        ...
                        <tbody>
                          <?php 
                            if(isset($students)){
                                ...
                                while($student = $students->fetch()){
                                            ...
                                            echo '
                                                    <tr class="alert" role="alert">
                                                        <input type="hidden" name="ajouterN" value="$_GET["ajouterN"]">
                                                        <td>
                                                            '.$student['Nom_Mat'].'
                                                            <input type="text" name="Code_Mat" value="'.$student['Code_Mat'].'" style="display:none;"></input>
                                                        </td>
                                                        
                                                         <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="ds" ></input>
                                                            </div>
                                                        </td>
                                                         <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="examen" class="quantity form-control input-number"  >
                                                            </div>
                                                        </td>
                                                         <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="tp" class="quantity form-control input-number"  >
                                                            </div>
                                                        </td>
                                                         <td class="quantity">
                                                            <div class="input-group">
                                                                <input type="number" name="projet" class="quantity form-control input-number" >
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="email">
                                                                <span> '.$student['coeffMat'].' </span>
                                                                <span></span>
                                                            </div>
                                                        </td>
                                ...
                                <input type="submit" class="button" title="ajouter" name="ajouter" value="Ajouter">
                               </form>
                              <button id="submitButton" type="submit" style="border:none;box-shadow:0 0 5px rgba(0,0,0,0.5);border-radius:20px; margin-left:700px; width: 200px;margin-top: 10px;"><a href="tester.php" style="color:black">liste des notes</a></button>
                    </div>
                </form>
                </div>
            </div>
