                        ...
                        <tbody>
                           <?php 
                            if(isset($students)){
                                ...
                                while($student = $students->fetch()){
                                    if($etat === $student['CNE']){
                                        ...
                                        <tr class="alert" role="alert">
                                            ...
                                            <th class="text-center"><a href="supprimernote.php?sup=<?php echo $student["Nom_eval"] ?>Supprimer</a>         
                                            </th>
                                             <th class="text-center"><a href="modifiernote.php?sup=<?php echo $student["Nom_eval"] ?>Enregistrer</a>         
                                            </th>
                             ...
                             <button id="submitButton" type="submit" style="border:none;box-shadow:0 0 5px rgba(0,0,0,0.5);border-radius:20px; margin-left:700px; width: 300px;font-size: 20px;"><a href="ajouternotes.php" style="color:black">Ajout des notes</a></button>
