...
if(isset($_POST['module'])){
    ...
    $students = $admin->Semestres($_SESSION['module']);
}
                    ...
                    <div class="table-wrap" style="margin-bottom:100px;">
                        ...
                        <thead class="thead-primary">
                            <tr>
                                ...
                                <th style="text-align:center;margin:0;padding:25px 5px;"colspan=4 align="center">Evaluation</th>
                                <tr>
                                <td width="20%" >DS</td><td width="20%">Examen</td><td width="20%">Tp</td><td width="20%" align="right">Projet</td>
                                </tr>
                            ...
                            if(isset($students)){
                                while($student = $students->fetch()){
                                                    ...
                                                    <tr class="alert" role="alert">
                                                        <td>
                                                            '.$student['CNE'].'
                                                            <input type="text" name="CNE" value="'.$student['CNE'].'" style="display:none;">
                                                        </td>
                                                        
                                                         <td class="quantity">
                                                            <div class="input-group">
                                                               '.$student['Nom'].''.$student['Prenom'].'
                                                            <input type="text" name="NomPrenom" value="' .$student['Nom'].'' .$student['Prenom'].'" style="display:none;">
                                                            </div>
                                                        </td>
                                                         <td class="quantity">
                                                           <div class="input-group">
                                                               '.$student['Nom_Mat']. '
                                                            <input type="text" name="Nom_Mat" value="' .$student['Nom_Mat'].'" style="display:none;">
                                                            </div>
                                                        </td>
