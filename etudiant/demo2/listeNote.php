...
<div class="container">
            <div class="table-wrap" style="margin-bottom:100px;">
                    <h2 class="heading-section">Liste des notes</h2>
                    <table class="table table table-bordered mb-4">
                        <thead class="thead-primary">
                            <tr>
                                ...
                                <th style="text-align: center;margin:0;padding:25px 5px;">Type d'évaluation</th>
                        ...
                        <tbody>
                           <?php
                            $reponse = $db->prepare('select * from evaluation ');
                            $result = $reponse->execute(); 
                                ...
                                <tr>
                                <td><?= $student['CNE']; ?></td>
                                <td><?= $student['Nom_Mat']; ?></td>
                                <td><?= $student['Nom_eval']; ?></td>
                                <td><?= $student['coeffMat']; ?></td>
                                <td class="text-left"><a href="supprimerinfo.php?supid=<?= $a['id_matinfo']; ?>">Supprimer </a></td>
                                <td class="text-left"><a href="formulairemodifierinfo.php?edit=<?= $a['id_matinfo']; ?>">Modifier</a></td>
                                </tr>
                            <?php
                               } 
                            }
