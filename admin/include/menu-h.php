                                ...
                                <div class="">
                                    <div class="media notification-new">
                                        ...
                                        <div class="media-body">
                                                <p class="meta-user-name mr-3">1 messageExemple</p>
                                                <p class="message-text">Lorem ipsm chi la3ba</p>
                                                <p class="meta-time align-self-center mb-0">Il ya 2h</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="notification-para"><span class="user-name">Etudiant</span>1 Notification Exemple</div>
                                        <div class="notification-meta-time">il ya 5 mins</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">                            
                            <div class="media mx-auto">
                                ...
                                <div class="media-body">
                                    <h5>El nafaa</h5>
                                    <p>Responsable de scolarité ESTS</p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown-item">
