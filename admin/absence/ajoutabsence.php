...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <?php include '../include/menu-v.php'; ?>
        ...
        <div class="container">
			<div class="row justify-content-center">
            <a href="absences.php"><button class="buttoninajout"><font color="white">Table d'absence---></font></button></a>
				<div class="col-md-6 text-center mb-4">
					<h2 class="heading-section">Ajout d'absence</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h3 class="h5 mb-4 text-center" style="display: flex;flex-direction:row;justify-content:space-evenly; width: 52em;">
						...
						<form action="" method="post">
							...
							<select class="inputs" style="width:5em;"name="classe">
							<?php 
								if(isset($_SESSION['classe'])){
						...
						<form action="test.php" method="post" id="mainabsenceform">
							<label for="matiere">Matiere : </label>
							<select class="inputs" style="width:11em;" name="matiere" required>
							<?php 
								echo '<option value="">Choisir Une matiere</option>';
								if(isset($_SESSION['classe'])){
							...
							<input class="inputs" style="width:10em;" type="date" name="date" required></input>
					</h3>
								...
								<table class="table">
									<thead class="thead-primary">
										<tr>
											...
											<th>Student Name</th>
											<th></th>
											<th style="font-size:1em !important;">Nombre des heures</th>
											<th></th>
										</tr>
									</thead>
									<tbody>
													...
													<tr class="alert" role="alert">
														...
														<td class="quantity">
															<div class="input-group">
																<input type="number" name="nbheures['.$count.']" class="quantity form-control input-number" min="0" max="8" value="0" step="2">
															</div>
														</td>
														<td></td>
													</tr>';
						...
						<button class="ajoutabsence" id="submitButton" type="submit"><a href="" style="color:white">Ajout des absences</a></button>
						</form>
				</div>
			</div>
		</div>
