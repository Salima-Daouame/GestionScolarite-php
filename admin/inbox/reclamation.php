...
if(isset($_POST['filtrer'])){
    while($row=$result->fetch()){
        ...
        $res->execute([$row['CNE']]);
        $r=$res->fetch();
        // $res2=$db->prepare("SELECT * FROM class WHERE Id_class=?;");
        // $res2->execute([$r['Id_class']]);
        // $res2=$res2->fetch();
        // echo $res2['Code_Filiere'];
        if($r['Id_class']==$_POST['class']){
            $Avatar=$r['Avatar'];
            $Id_Reclamation=$row['Id_Reclamation'];
            $Reclamation=$row['Reclamation'];
            $Sujet=$row['Sujet'];
            $reclamation=$reclamation."
            <div class='person' data-chat='{$Id_Reclamation}'>
                <div class='user-info'>
                    <div class='f-head'>
                        <img src='../../etudiant/{$Avatar}' alt='avatar'>
                    </div>
                    <div class='f-body'>
                        <div class='meta-info'>
                            <span class='user-name' data-name='Sean Freeman'>{$r['Nom']} {$r['Prenom']}</span>
                            <span class='user-meta-time'>2:09 PM</span>
                        </div>
                        <span class='preview'>{$Reclamation}</span>
                    </div>
                </div>
            </div>";
            $rec=$rec."
            <div class='chat' data-chat='{$Id_Reclamation}'>
                <p>Sujet : {$Sujet}</p>
                <p>{$Reclamation}</p>
            </div>
            ";
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            ...
                            <div class="chat-system">
                                ...
                                <div class="user-list-box" style="overflow: hidden;">
                                    <div class="search">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                        <input type="text" class="form-control" placeholder="Search" />
                                    </div>
                                    <form action="" method="POST" style="padding-top: 10px;padding: 0 20px;">
                                    ...
                                    <div class="chat-box-inner">
                                        <div class="chat-meta-user">
                                            ...
                                            <div class="chat-action-btn align-self-center">
                                                ...
                                                <!-- <button>Marquer comme traité</button> -->
                                            </div>
                                        </div>
                                        <div class="chat-conversation-box">
                                            <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                                <div class="chat" data-chat="person1">
                                                    ...
                                                    <!-- <div class="chat" data-chat="D130035108">
                                                        <p style="color: black;">Oussama Elaji</p>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ac vehicula risus. Praesent dignissim ipsum id turpis tempor, non blandit ipsum dignissim. Integer eget faucibus est. Mauris euismod erat vehicula dictum varius. Quisque feugiat malesuada dictum. Nunc metus metus, placerat a ullamcorper eget, sagittis vehicula purus. Maecenas consectetur consequat dictum. Ut luctus, metus et commodo blandit, diam diam tincidunt nisl, quis pellentesque felis nibh ut ex.
                                                            In sit amet eros elementum, laoreet magna et, eleifend ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at tortor a ex pretium tincidunt id quis mi. Praesent rutrum, enim lacinia fermentum eleifend, enim est semper eros, non mattis eros lorem in libero. Etiam purus enim, egestas sit amet arcu scelerisque, ultricies pellentesque risus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. N